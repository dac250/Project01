package com.example.dan.networkingtest;
...
public class HttpExampleActivity extends Activity {
    ...
    public void onCreate(Bundle savedInstanceState) {
        ...
        try {
            ...
            if (buffer.length() == 0) {
                // Empty stream, do not parse
                //return null;
            }
            forecastJsonStr = buffer.toString();
        } catch (IOException e) {
            //Log.e(LOG_TAG, "Error ", e);
            // Error retrieving data, do not parse
            //return null;
        } finally {
    ...
    public void onStart() {
        ...
        Action viewAction = Action.newAction(
                ...
                "HttpExample Page", // TODO: Define a title for the content shown.
                // TODO: If you have web page content that matches this app activity's content,
                // make sure this auto-generated web page URL is correct.
                // Otherwise, set the URL to null.
                Uri.parse("http://host/path"),
                // TODO: Make sure this auto-generated app URL is correct.
                Uri.parse("android-app://com.example.dan.networkingtest/http/host/path")
        );
